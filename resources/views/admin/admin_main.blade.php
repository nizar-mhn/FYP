                ...
                <div class="col-3 offset-2 p-2 mt-4">
                    <div class="container">
                        <form action="{{ route('getCourseList') }}" method="post">
                            @csrf
                            <h3>Program</h3>
                            <select class="form-select form-select-lg" name="programID" aria-label="" style="width: 300px"
                            ...
                            <button type="button" class="btn text-light mt-3" data-bs-toggle="modal" id="newProgramButton"
                                data-bs-target="#programModal" style="background-color:#E76F51"><i
                                    class="bi bi-plus-square me-2"></i>Add new
                                program</button>
                                    ...
                                    <form action="{{ route('addProgram') }}" method="post">
                                        ...
                                        <div class="modal-footer">
                                            <button type="submit" class="btn btn-primary"
                                                id="newProgramButtonModal">Submit</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                        ...
                        @if (count($courseID))
                            <div class="container">
                                    ...
                                    <div class="row border">
                                        ...
                                        <div class="col-md-4 pt-2">
                                            <form action="{{route('deleteCourseList')}}" method="post">
                                                ...
                                                <button class="btn btn-danger btnDelete text-light" type="submit"><i
                                ...
                                <form action="{{ route('addCourseList') }}" method="POST">
                                    ...
                                    @endphp
                                    <select class="form-select form-select-lg" name="courseID" aria-label=""
                                        style="width: 300px" id="bindingTypeSelect">
                                    ...
                                    <button type="submit" class="btn text-light mt-3"
                                        style="background-color:#E76F51"><i class="bi bi-send-plus-fill me-2"></i>Add
                                        Course</button>
                                </form>
