        ...
        <div class="col-md-8 offset-2 mt-4">
            <div class="row p-3">
                ...
                <div class="col-md-3 text-center">
                    <a href="" class="btn text-light" style="background-color: #12355B" data-bs-toggle="modal" id="newCourseButton" data-bs-target="#courseModal">Add Course</a>
                            ...
                            <div class="modal-content">
                                ...
                                <form action="{{ route('addCourse') }}" method="post">
                                    <div class="modal-body">
                                        <div class="row">
                                            <div>
                                                <br />
                                                @csrf
                                                <label for="courseName" class="">{{ __('Course Name') }}</label>
                                        ...
                                        <div class="row">
                                            <div>
                                                <br />
                                                @csrf
                                                <label for="courseCode" class="">{{ __('Course Code') }}</label>
                                    ...
                                    <div class="modal-footer">
                                        <button type="submit" class="btn btn-primary" id="newProgramButtonModal">Add</button>
                                    </div>
                                </form>
                            </div>
                        </div>
            ...
            <div class="row border p-2">
                ...
                <div class="col-md-3 text-center">
                    <a href="" class="btn text-light" style="background-color: #12355B" data-bs-toggle="modal" id="newCourseButton" data-bs-target="#courseEdit{{ $course->courseID }}">Edit</a>
                    <div class="modal fade" id="courseEdit{{ $course->courseID }}" tabindex="-1" aria-labelledby="courseEditLabel{{ $course->courseID }}" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <form action="{{ route('editCourse') }}" method="post">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" class="btn btn-primary" id="newProgramButtonModal">Save</button>
                                    </div>
                                </form>
                            </div>
                        </div>
