    ...
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-dark shadow-sm navbarColor">
            <div class="container">
                ...
                <a class="navbar-brand" href="{{ route('supplierMainPage') }}">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('supplierMainPage') }}">Home</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('supplierReport')}}">Report</a>
                        </li>
                        @guest
                        @if (Route::has('login'))
                        <li class="nav-item">
